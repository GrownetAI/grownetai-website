...
const PERKS = [
  {
    icon: TrendingUp,
    title: "Fast Growth",
    desc: "Work on real campaigns with real budgets. Learn faster than anywhere else.",
  },
  {
    icon: Laptop,
    title: "Remote Friendly",
    desc: "Most roles are remote or hybrid. We care about output, not clock-ins.",
  },
  {
    icon: Zap,
    title: "AI-First Culture",
    desc: "We use cutting-edge AI tools daily. You'll be ahead of the industry.",
  },
  {
    icon: Heart,
    title: "Great Team",
    desc: "Small, tight-knit team of marketers, creators, and builders who love what they do.",
  },
  {
    icon: Coffee,
    title: "Flexible Hours",
    desc: "We trust adults to manage their time. Results matter more than rigid schedules.",
  },
  {
    icon: Star,
    title: "Performance Bonuses",
    desc: "Hit targets and you'll be rewarded. We share the wins with the team.",
  },
];
...
const applySchema = z.object({
  ...
  portfolio: z
    .string()
    .url("Enter a valid URL (e.g. LinkedIn or portfolio link)")
    .optional()
    .or(z.literal("")),
  message: z
    .string()
    ...
    <div className="card overflow-hidden">
      ...
      >
        <div className="flex-1">
          ...
          <p className="text-brand-slate-gray text-sm mt-1">
            {job.description}
          </p>
        </div>
        <ChevronDown
            ...
            <div>
              ...
              <ul className="space-y-2">
                {job.responsibilities.map((r) => (
                  <li
                    key={r}
                    className="flex items-start gap-2 text-sm text-brand-slate-gray"
                  >
                    <span
...
export default function CareersPage() {
  ...
  const waHref = whatsappUrl(
    ...
    "Hi GrownetAI! I'm interested in joining your team.",
  );
      ...
      <section className="relative bg-gradient-hero py-24 overflow-hidden">
        ...
        <div className="container-site relative z-10 text-center">
          ...
          <p className="text-white/80 text-xl max-w-2xl mx-auto mb-8">
            Join a fast-moving team of marketers, creators, and tech builders
            helping Indian businesses grow with AI-powered strategies.
          </p>
        ...
        <div className="container-site">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              <div key={stat.label}>
                <p className="font-heading font-bold text-3xl text-brand-teal">
                  {stat.value}
                </p>
                <p className="text-brand-slate-gray text-sm mt-1">
                  {stat.label}
        ...
        <div className="container-site">
          <div className="text-center mb-12">
            ...
            <h2 className="heading-section mt-2">
              Why You&apos;ll{" "}
              <span className="text-gradient">Love It Here</span>
            </h2>
          </div>
        ...
        <div className="container-site max-w-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-body mt-3">
              Fill in the form below. We review every application and respond
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-brand-charcoal font-heading">
                ...
                <span className="text-brand-slate-gray font-normal ml-1">
                  (optional)
                </span>
              </label>
              <input
      ...
      <section className="py-16 bg-white">
        <div className="container-site text-center max-w-2xl mx-auto">
          ...
          <p className="text-brand-slate-gray mb-6">
            We&apos;re always open to talented people. Drop us your profile on
            WhatsApp and we&apos;ll keep you in mind for future openings.
          </p>
