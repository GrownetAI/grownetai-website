...
async function sendEmail(data: z.infer<typeof schema>) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <div style="background: linear-gradient(135deg, #1AABAB, #3BC456); padding: 30px; border-radius: 12px 12px 0 0;">
      ...
      <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #e5e7eb;">
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr><td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; color: #6b7280; font-weight: 600;">Email</td><td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;"><a href="mailto:${sanitize(data.email)}" style="color: #1AABAB;">${sanitize(data.email)}</a></td></tr>
          ...
          <tr><td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; color: #6b7280; font-weight: 600;">Role</td><td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; color: #111827; font-weight: 700; color: #1AABAB;">${sanitize(data.role)}</td></tr>
          <tr><td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; color: #6b7280; font-weight: 600;">Portfolio</td><td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">${data.portfolio ? `<a href="${sanitize(data.portfolio)}" style="color: #1AABAB;">${sanitize(data.portfolio)}</a>` : "—"}</td></tr>
        ...
        <div style="margin-top: 24px; padding: 16px; background: #eff6ff; border-radius: 8px; border-left: 4px solid #1AABAB;">
