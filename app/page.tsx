            ...
            >
              ...
              <div className="space-y-4 text-body-lg">
                <p>
                  ...
                  likes — numbers that look impressive and change nothing in
                  your bank account.
                </p>
                <p>
                  So we built the opposite: one AI-powered team that owns your
                  whole funnel — the website, the ads, the SEO, the content —
                  and answers to a single number that matters. Revenue.
                </p>
              ...
              >
                <div className="flex gap-0.5">
                  {Array.from({ length: t.rating }).map((_, idx) => (
                    <Star
                      key={idx}
                      className="w-4 h-4 fill-[#E0A32E] text-[#E0A32E]"
                    />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-hairline">
                  <div
                    className="w-9 h-9 rounded-full flex items-center justify-center text-paper font-semibold text-xs flex-shrink-0"
                    style={{ background: INK }}
                  >
                    {t.name
                      .split(" ")
