...
export const TEAM = [
  ...
  {
    name: "Srishti Masand",
    role: "Business Analyst & Sales Specialist",
  ...
  {
    name: "Bhawna Singh",
    role: "BDE & Automation Testing Engineer",
    bio: "Business development executive and automation testing engineer with expertise in automation testing and process optimization for digital marketing campaigns.",
    avatar: "/images/team/bhawna.jpg",
    linkedin: "#",
    twitter: "#",
  },
];
...
export const PORTFOLIO_PROJECTS = [
  {
    ...
    emoji: "🚗",
    navItems: ["Shop", "Fitment", "Journal"],
    tagline: "Engineered for the drive that matters",
    sub: "Premium, exact-fit car accessories — matched to your exact model",
    cta: "Shop the Range",
    results: ["Exact-fit catalogue", "24h dispatch", "2-yr warranty"],
    serviceIds: ["web-dev", "smm", "ads"],
    previewImg: "/images/driv1.webp",
  },
  {
    id: 2,
    name: "Batra Cloth House",
    tag: "Fashion & E-commerce",
    emoji: "🥻",
    navItems: ["Sarees", "Lehengas", "Collections"],
    tagline: "Where Tradition Meets Elegance",
    sub: "India's finest handwoven sarees & artisan ethnic wear",
    cta: "Shop Now",
    results: ["2000+ styles", "50K+ customers", "100% handwoven"],
    serviceIds: ["web-dev", "design", "smm"],
    previewImg: "/images/bch1.webp",
  },
  {
    id: 3,
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    title: "A storefront where every part fits — exactly",
    challenge:
      "A premium car-accessories brand entering a market ruled by universal-fit marketplace listings, where buyers can never be sure a part will actually fit their car — and where the brand owns neither the storefront nor the customer.",
    solution:
      "We built drivman.com around exact-fit discovery: a brand → model → generation fitment selector wired into the whole catalogue, product pages that lead with verified fitment, and a premium identity that carries the “Engineered for the drive that matters” positioning.",
    outcome:
      "Every product is matched to the exact vehicle before checkout — most orders dispatch within 24 hours, and every part ships backed by a two-year warranty.",
    services: ["Logo & Brand Identity", "Website Development", "Social Media", "Google & Meta Ads"],
    serviceIds: ["design", "web-dev", "smm", "ads"],
    tech: ["E-commerce", "Google Ads", "Meta Ads"],
    results: [
      { metric: "Fitment matching", value: "Exact-fit" },
      { metric: "Order dispatch", value: "< 24 hrs" },
      { metric: "Warranty backed", value: "2 years" },
    ],
    image: "/images/driv1.webp",
    duration: "8 months",
  },
  {
    id: 2,
    slug: "batra-cloth-house",
    client: "Batra Cloth House",
    industry: "Fashion & E-commerce",
    title: "A heritage cloth house, now dressed for all of India",
    challenge:
      "Decades of trust and India's finest handwoven sarees — but all of it lived inside one store. No online catalogue, festive demand crammed into store hours, and brides discovering their Banarasi collections only by word of mouth.",
    solution:
      "We built the BCH online store around how women actually shop ethnic wear — by occasion, fabric and style — with the bridal and festive collections told as editorial stories, an offers engine for festive drops, and WhatsApp woven into the buying journey.",
    outcome:
      "The house now sells across India: 2,000+ handwoven styles online, festive collections that launch as events, and the 'Ethnic · Elegance · Heritage' brand carried from the storefront to the doorstep.",
    services: ["Website Development", "Logo & Brand Identity", "Social Media", "SEO & Performance"],
    serviceIds: ["web-dev", "design", "smm", "seo"],
    tech: ["E-commerce", "SEO", "Meta Ads"],
    results: [
      { metric: "Styles online", value: "2,000+" },
      { metric: "Happy customers", value: "50K+" },
      { metric: "Authentic handwoven", value: "100%" },
    ],
    image: "/images/bch1.webp",
    duration: "6 months",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    title: "Order dinner in a minute, book the whole function online",
    challenge:
      "A kitchen people loved, buried under phone orders and aggregator commissions — and every big-function enquiry (weddings, corporate lunches, parties) lived in missed calls and a notebook behind the counter.",
    solution:
      "We built the Foodies site around its two real jobs: order food now — a live menu with prices, prep times and one-tap ordering — and book big functions, an appointment flow that captures the date, guest count and menu preferences and confirms a consultation slot.",
    outcome:
      "Orders now come in directly with the menu always current, and function bookings arrive as structured appointments instead of missed calls — with offers and the newsletter bringing people back for the next order.",
    services: ["Brand Identity", "Website Development", "SEO & Performance", "Ads Management"],
    serviceIds: ["design", "web-dev", "seo", "ads"],
    tech: ["E-commerce", "Google Ads", "SEO"],
    results: [
      { metric: "Online orders", value: "+220%" },
      { metric: "Function bookings", value: "3× more" },
      { metric: "Repeat orders", value: "1 in 3" },
    ],
  ...
  },
  {
    ...
    client: "LC Luxe Interiors",
    industry: "Interiors & Architecture",
    title: "Luxury interiors, browsable room by room, category by category",
    challenge:
      "A premium interior design and build studio whose entire world — wall panels, flooring, wallpapers, soft furnishings, full villa projects — lived in showrooms and PDF catalogues. Homeowners couldn't explore styles, compare finishes or shortlist anything for their own home without visiting first.",
    solution:
      "We built the LC Luxe platform around choosing: an eight-category product explorer with search, Enquire and Quote on every product, the design services laid out from a single room to turnkey villas, and consultation booking so a shortlist becomes a site visit.",
    outcome:
      "Homeowners now browse by category, shortlist finishes for their own home and arrive at the consultation with choices already made — every enquiry lands with the product and room attached.",
    services: ["Website Development", "Logo & Brand Identity", "SEO & Performance"],
    serviceIds: ["web-dev", "design", "seo"],
    tech: ["E-commerce", "SEO"],
    results: [
      { metric: "Product categories", value: "8" },
      { metric: "Quote requests", value: "1-tap" },
      { metric: "Consultations", value: "2.5× more" },
    ],
