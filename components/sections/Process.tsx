...
export default function Process() {
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#3BC456]/[0.04] rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, #1AABAB40, #3BC45640, transparent)",
              }}
            />
                  ...
                  <div className="shrink-0 relative">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: "0 4px 20px rgba(26,171,171,.30)",
                      }}
                    >
                      {iconMap[step.icon]}
                    </div>
