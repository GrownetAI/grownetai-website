...
export default function TechStack() {
  ...
  return (
    ...
    >
      {/* Ambient */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#008080]/[0.04] rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="container-site relative z-10">
              ...
              style={
                active === cat
                  ? {
                      ...
                      boxShadow: "0 4px 16px rgba(0, 128, 128,.30)",
                    }
                  : {
        ...
        <div className="relative">
          <div
            ...
            style={{
              background: "linear-gradient(to right, #003B3B, transparent)",
            }}
          />
          <div
            className="absolute right-0 top-0 bottom-0 w-16 z-10 pointer-events-none"
            style={{
              background: "linear-gradient(to left, #003B3B, transparent)",
            }}
          />
